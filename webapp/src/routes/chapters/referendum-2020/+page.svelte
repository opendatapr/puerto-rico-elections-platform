<script lang="ts">
	...
	const t = {
		...
		es: {
			chapterTitle: 'El 52% Que No Cambió Nada',
			chapter: 'Capítulo',
			lead: 'El 3 de noviembre de 2020, Puerto Rico celebró su sexto referéndum de estatus. Por primera vez en la historia, una mayoría simple votó "Sí" a la estadidad. El Congreso escuchó el resultado. El Congreso no hizo nada.',
			loading: 'Cargando datos...',
			// Viz titles and labels
			theQuestion: 'La Pregunta',
			ballotQuestion: '¿Debe Puerto Rico ser admitido inmediatamente en la Unión como un Estado?',
			votedYes: 'votaron SÍ',
			...
			senatorialNote: 'Los 8 distritos votaron Sí, pero los márgenes variaron ampliamente',
			turnoutComparison: 'Participación: Referéndum vs Elección General',
			governorRace: 'Carrera de Gobernador',
			referendum: 'Referéndum',
			turnoutNote: '~50,000 votantes menos participaron en el referéndum que en la carrera de gobernador',
			historicalTitle: 'Seis Referéndums, Seis Décadas',
			historicalNote: '*2017 excluido debido al boicot de la oposición (23% de participación)',
			globalTitle: 'Cómo se Compara el 52.5% Globalmente',
			globalNote: 'Brexit pasó con 51.9%. Escocia se quedó con 55.3% en contra.',
			statehoodSupportLabel: 'Apoyo a la Estadidad',
			year: 'Año',
			// Step titles and content
			step0Title: 'Una Papeleta Más Simple',
			step0p1: 'Los referéndums de estatus anteriores ofrecían múltiples opciones: estadidad, independencia, libre asociación, estado libre asociado mejorado. Los críticos argumentaban que la confusión diluía los resultados y hacía imposible la interpretación.',
			step0p2: 'El referéndum de 2020 fue diferente. Por primera vez, los votantes enfrentaron una sola pregunta binaria. Sin ambigüedad. Sin votos de protesta en blanco.',
			step0p2b: 'Solo',
			step0p2c: 'o',
			step0p3: 'La pregunta en sí era sin precedentes en su franqueza: ¿debe Puerto Rico ser admitido',
			step0p3b: 'en la Unión como Estado?',
			immediately: 'inmediatamente',
			yes: 'Sí',
			step1Title: 'El Conteo Comienza',
			step1p1: 'Cuando cerraron las urnas en la noche de elecciones, los puertorriqueños observaban los resultados llegar junto con la caótica carrera presidencial estadounidense. El drama propio de la isla se desarrollaba simultáneamente.',
			step1p2: 'Precinto por precinto, los votos de Sí se acumulaban. El margen era estrecho pero consistente. Para la medianoche, la trayectoria era clara: la estadidad ganaría su primera mayoría en un referéndum vinculante.',
			step1p3: 'Observa el porcentaje final emerger...',
			step2Title: 'Un Umbral Histórico',
			step2p1pre: '',
			step2p1mid: 'votó Sí.',
			step2p1b: 'votó No. Después de seis referéndums abarcando 53 años, la estadidad finalmente cruzó el umbral del 50%.',
			step2p2pre: 'El margen de',
			step2p2mid: 'votos fue mayor que muchos márgenes presidenciales estadounidenses en estados clave. Fue decisivo por cualquier estándar democrático excepto uno: el Congreso no tiene que escuchar.',
			step2p3: 'Puerto Rico había hablado. La pregunta era si Washington escucharía.',
			step3Title: 'Mapeando el Voto',
			step3p1: 'Los resultados del referéndum variaron dramáticamente a través de los 78 municipios de Puerto Rico. La geografía, la historia y la lealtad partidista moldearon cómo votaron las comunidades.',
			step3p2: 'A diferencia de la carrera de gobernador, donde las líneas partidistas son claras, la cuestión del estatus cruza los límites políticos tradicionales. Algunos municipios tradicionalmente del PNP votaron No; algunos bastiones del PPD sorprendieron con mayorías de Sí.',
			step3p3: 'El mapa muestra dónde la estadidad encontró su mayor apoyo.',
			step4Title: 'La División Geográfica',
			step4p1pre: 'El mapa revela patrones claros.',
			step4p1a: 'Las áreas verde azuladas',
			step4p1b: 'votaron Sí por encima del 50%;',
			step4p1c: 'las áreas rojas',
			step4p1d: 'votaron No. La intensidad muestra el margen de victoria.',
			step4p2pre: '',
			step4p2a: 'lideró la isla con 60.6% Sí, mientras que',
			step4p2b: 'fue el más opuesto con solo 41.3%. Las dos pequeñas islas frente a la costa este votaron en direcciones opuestas, un microcosmos del debate más amplio.',
			step4p3pre: 'Notablemente, San Juan, la capital y ciudad más grande, votó estrechamente',
			step4p3a: 'en contra',
			step4p3b: 'de la estadidad con 49.8%, aceptando el statu quo aun cuando la mayoría a nivel de isla exigía cambio.',
			step5Title: 'Cada Distrito Dijo Sí',
			step5p1: 'Puerto Rico está dividido en ocho distritos senatoriales para representación legislativa. En el referéndum de 2020, los ocho votaron Sí a la estadidad, aunque con márgenes variados.',
			step5p2: 'Bayamón II lideró con 55.2% Sí, reflejando la inclinación pro-estadidad del anillo suburbano alrededor de San Juan. San Juan I y Guayama VI mostraron los márgenes más estrechos, apenas cruzando el umbral del 50%.',
			...
			step6Title: 'La Brecha de Participación',
			step6p1: 'Los críticos del referéndum señalaron la participación. Mientras el 54.7% de los votantes registrados emitieron votos en la carrera de gobernador, solo el 52.3% participó en el referéndum de estatus, a pesar de aparecer en la misma papeleta.',
			step6p2: 'Esa brecha de 2.4 puntos porcentuales representa aproximadamente 50,000 votantes que eligieron al gobernador pero omitieron la pregunta del referéndum. Algunos boicotearon por principio; otros simplemente no les importó.',
			step6p3: 'Los opositores a la estadidad argumentaron que esta brecha socavaba el mandato. Los partidarios respondieron que el 52% de participación supera a la mayoría de las elecciones intermedias de EE.UU. y que la abstención sigue siendo participación, solo participación pasiva.',
			step7Title: 'El Largo Arco del Estatus',
			step7p1: 'El resultado de 2020 se ubica dentro de una trayectoria de 53 años. Del 39% en 1967 al 52.5% en 2020, el apoyo a la estadidad ha crecido de manera constante, con un valor atípico dramático.',
			step7p2: 'El referéndum de 2017, boicoteado por el PPD y el PIP, produjo un resultado sin sentido del 97% para la estadidad con solo 23% de participación. Ese referéndum enseñó una lección importante: la legitimidad del proceso importa tanto como el resultado.',
			step7p3: 'El referéndum de 2020 fue diseñado para evitar esos escollos. Papeleta simple. Alta participación. Margen claro. Sin embargo, el resultado seguía siendo no vinculante, consultivo, ignorable.',
			step8Title: '52% en Contexto Global',
			step8p1: '¿Cómo se compara el 52.5% de Puerto Rico con otros referéndums consecuentes? Brexit pasó con 51.9%, desencadenando la salida del Reino Unido de la Unión Europea. Escocia permaneció en el Reino Unido después de que el 55.3% votara contra la independencia.',
			step8p2: 'El margen de Puerto Rico fue mayor que el de Brexit. Fue más decisivo que el voto de independencia de Quebec del 49.4% en 1995. Por los estándares que gobiernan la autodeterminación en otros lugares, el 52.5% debería tener consecuencias.',
			step8p3: 'Pero Puerto Rico no es una nación soberana celebrando un referéndum sobre su futuro. Es una colonia pidiendo permiso al Congreso. La comparación ilumina el déficit democrático en el corazón del estatus del territorio.',
			step9Title: 'El Silencio de Washington',
			step9p1: 'Después del 3 de noviembre de 2020, la atención del mundo estaba en otro lugar: una elección presidencial disputada, una pandemia desatada, un capitolio que sería asaltado en enero. El referéndum de Puerto Rico apenas registró en los medios continentales.',
			step9p2: 'El Congreso ha introducido proyectos de ley de estadidad en sesiones subsiguientes. Ninguno ha pasado. El Senado ha mostrado poco interés. El 52.52% que votó Sí en 2020 no ha recibido ni admisión ni rechazo, solo el silencio colonial familiar.',
			step9p3: 'El referéndum respondió la pregunta de Puerto Rico. No respondió la pregunta de Estados Unidos: ¿aceptará Estados Unidos un estado 51, con todo el realineamiento político que eso implica?',
			// Conclusion
			conclusionTitle: 'La Paradoja Colonial',
			conclusionP1: 'El referéndum de 2020 cristaliza la contradicción democrática de Puerto Rico. Sus residentes pueden votar, pero sus votos no pueden obligar a la acción. Expresaron una preferencia, pero las preferencias no atan a los poderes coloniales. El 52.52% no cambió nada porque el referéndum nunca fue diseñado para cambiar nada. Fue diseñado para expresar. Expresión sin consecuencia es la definición de gobernanza colonial.',
			statVotedYes: 'Votaron Sí por la estadidad',
			statVoteMargin: 'Margen de votos',
			statReferendum: 'Referéndum de estatus desde 1967',
			statCongressVotes: 'Votos del Congreso sobre admisión desde entonces',
			// Newspaper headline
			dateline: 'SAN JUAN, 4 de noviembre de 2020',
			headline: 'Puertorriqueños Votan por la Estadidad; Se Espera que el Congreso No Haga Nada',
			subhead: 'En el sexto referéndum sobre estatus político, una mayoría finalmente respalda la admisión a la Unión. Expertos dicen que el resultado es "consultivo" y "no vinculante", planteando preguntas sobre el propósito del ejercicio.',
			// Sources
			sources: 'Fuentes',
			sourceCEE: 'Resultados del referéndum 2020 por municipio',
			sourceCensus: 'Datos de población y demográficos de Puerto Rico',
			sourceBrexit: 'Datos del referéndum del Brexit (2016)',
			sourceScotland: 'Datos del referéndum de independencia de Escocia (2014)',
			// Navigation
			previous: 'Anterior',
			nextChapter: 'Próximo Capítulo',
			prevTitle: 'Una Pregunta, Dos Décadas',
			nextTitle: 'Divididos por Diseño'
		}
	};
